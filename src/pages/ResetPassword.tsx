  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-[#F8FAFF] px-2 sm:px-4 md:px-6 lg:px-8">
      ...
      <div className="flex justify-between items-center py-3 sm:py-4 md:py-6">
        ...
        <select className="border rounded-lg px-2 py-1 text-xs sm:text-sm md:text-base text-gray-700 shadow-sm bg-white sm:px-3 md:px-4 md:py-2">
      ...
      <div className="flex flex-col items-center justify-center flex-grow text-center px-2 sm:px-4 md:px-0">
        {!success ? (
          <>
            ...
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-900 mb-2">Définir un nouveau mot de passe</h2>
            <p className="text-xs sm:text-sm md:text-base text-gray-50c0 mb-6 sm:mb-8">Entrez votre nouveau mot de passe ci-dessous</p>
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-[320px] sm:max-w-md lg:max-w-lg space-y-3 sm:space-y-4 md:space-y-6">
              <div className="text-left relative">
                <label className="block text-xs sm:text-sm font-medium text-gray-700">Nouveau mot de passe</label>
              ...
              <div className="text-left relative">
                <label className="block text-xs sm:text-sm font-medium text-gray-700">Confirmer le mot de passe</label>
                <div className="relative">
                  <input
          ...
          <>
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-500 mb-4 sm:mb-6 max-w-[280px] sm:max-w-sm md:max-w-lg px-2 sm:px-4">
      ...
      {/* Footer */}
      <div className="text-gray-500 text-[10px] sm:text-xs md:text-sm text-center py-3 sm:py-4 md:pb-6">

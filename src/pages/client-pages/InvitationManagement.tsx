            ...
            <div className="max-w-[1414px] max-h-[698px] flex flex-col justify-between pt-10 shadow-md bg-[#ECFEE2] bg-opacity-30 rounded-[40px]">
                <div className="flex flex-wrap gap-8 items-start self-center max-w-[1414px]">
                    <div className="flex flex-wrap gap-5 items-start min-w-[240px] w-[870px] max-md:max-w-full">
                        ...
                        <div className="flex flex-col min-w-[412px] text-[#090933] w-[412px]">
                            <h1 className="font-lufga text-[26px] font-bold">Invitation Management</h1>
                            <p className="text-[16px] font-lufga font-regular">
                    ...
                    <div className="flex flex-1 shrink gap-2.5 justify-center items-center px-8 py-3.5 text-lg rounded-3xl basis-0 bg-[#7C829C] bg-opacity-10 min-h-[55px] min-w-[240px] text-[#7C829C] max-md:px-5">
                        ...
                        <input
                            ...
                            className="flex-1  font-lufga text-[20px] shrink self-stretch my-auto basis-0 bg-transparent border-none outline-none"
                        />
                    </div>
                ...
                <div className="flex flex-col justify-between p-10 mt-12 bg-white min-h-[49px] rounded-[40px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-col w-full max-md:max-w-full">
                        <div className="flex flex-wrap gap-2 justify-between items-center px-5 w-[1334px] bg-[#7C829C] bg-opacity-10 h-[49px] rounded-[30px] max-md:max-w-full">
                            ...
                            <div className="font-lufga my-auto text-sm font-semibold text-[#7C829C] w-full max-w-[210px]">
                                Guest Name
                            </div>
                            <div className="font-lufga my-auto text-sm font-semibold text-center text-[#7C829C] w-full max-w-[317px]">
                                Email
                            </div>
                            <div className="font-lufga my-auto text-sm font-semibold text-center text-[#7C829C] w-full max-w-[165px]">
                                Sent Date
                            </div>
                            <div className="font-lufga my-auto text-sm font-semibold text-center text-[#7C829C] w-full max-w-[197px]">
                                Expiration Date
                            </div>
                            <div className="font-lufga my-auto text-sm font-semibold text-center text-[#7C829C] w-full max-w-[148px]">
                                Status
                            </div>
                            <div className="font-lufga my-auto text-sm font-semibold text-center text-[#7C829C] w-full max-w-[87px]">
                                Action
                            </div>
                        </div>

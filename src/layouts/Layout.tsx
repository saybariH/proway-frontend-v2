...
const CoachLayout: React.FC = () => {
    return (
        ...
        <div className="w-screen h-screen max-w-[1920px] max-h-[1117px] py-[1.56%] px-[1.56%] bg-bg-gradient opacity-100">
            <div className="w-full h-full grid grid-cols-[13%_86%] gap-[1%]">
                ...
                <div className="w-full h-full bg-white grid grid-rows-[8%_90%] gap-[2%]">
